 function result = fusionMadgwickOriginal(result, acc, gyr, mag, beta, zeta, deltat)
...
%      SEq_1, SEq_2, SEq_3, SEq_4;  % estimated orientation quaternion elements with initial conditions   

    SEq_1 = result(1); SEq_2 = result(2); SEq_3 = result(3); SEq_4 = result(4); b_x = result(5); b_z = result(6);
